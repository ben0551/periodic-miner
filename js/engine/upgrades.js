...
const UpgradeEngine = {
  ...
  UPGRADES: [
    ...
    // ── More late-game upgrades ───────────────────────────
    {
      ...
      name: 'Transition Metal Mastery',
      desc: 'Harness transition metals — all transition metals ×1.8.',
      cost: 3000,
      elementCost: [{ atomicNumber: 26, amount: 50000 }, { atomicNumber: 29, amount: 30000 }],
      effect: { type: 'multiply', target: 'category:transition-metal', factor: 1.8 },
      requires: [],
    },
    {
      id: 'noble-amplification',
      name: 'Noble Gas Amplification',
      desc: 'Boost all noble gas production ×2.5.',
      cost: 4000,
      elementCost: [{ atomicNumber: 2, amount: 50000 }, { atomicNumber: 10, amount: 40000 }, { atomicNumber: 18, amount: 30000 }],
      effect: { type: 'noble-boost', target: 'all', factor: 2.5 },
      requires: ['ne-array'],
    },
    {
      id: 'halogen-extraction',
      name: 'Halogen Extraction',
      desc: 'Better halogen synthesis — all halogens ×2.',
      cost: 2500,
      elementCost: [{ atomicNumber: 17, amount: 80000 }, { atomicNumber: 35, amount: 40000 }],
      effect: { type: 'multiply', target: 'category:halogen', factor: 2 },
      requires: [],
    },
    {
      id: 'period4-synthesis',
      name: 'Period 4 Synthesis',
      desc: 'Unlock advanced synthesis for Period 4 — all Period 4 ×2.2.',
      cost: 6000,
      elementCost: [{ atomicNumber: 19, amount: 100000 }, { atomicNumber: 26, amount: 75000 }, { atomicNumber: 29, amount: 50000 }],
      effect: { type: 'multiply', target: 'period:4', factor: 2.2 },
      requires: [],
    },
    {
      id: 'offline-2',
      name: 'Deep Space Mining Station',
      desc: 'Orbital platform for autonomous mining — offline cap +20 hours.',
      cost: 1500,
      elementCost: [{ atomicNumber: 26, amount: 200000 }, { atomicNumber: 26, amount: 100000 }],
      effect: { type: 'offline-hours', bonus: 20 },
      requires: ['co2-scrubbing'],
    },
    {
      id: 'prestige-2',
      name: 'Prestige Multiplier',
      desc: 'Each prestige grants +15% permanent production.',
      cost: 8000,
      elementCost: [{ atomicNumber: 1, amount: 500000 }, { atomicNumber: 26, amount: 200000 }],
      effect: { type: 'prestige-bonus', factor: 0.15 },
      requires: ['prestige-1'],
    },
    {
      id: 'drill-efficiency',
      name: 'Drill Efficiency Boost',
      desc: 'Advanced drill engineering — all drill costs -30%.',
      cost: 3500,
      elementCost: [{ atomicNumber: 6, amount: 150000 }, { atomicNumber: 26, amount: 100000 }],
      effect: { type: 'drill-discount', factor: 0.7 },
      requires: ['drill-discount-1'],
    },
    {
      id: 'elemental-fusion',
      name: 'Elemental Fusion',
      desc: 'Fuse elements for greater power — all production ×1.7.',
      cost: 10000,
      elementCost: [{ atomicNumber: 1, amount: 500000 }, { atomicNumber: 6, amount: 300000 }, { atomicNumber: 8, amount: 400000 }],
      effect: { type: 'multiply', target: 'all', factor: 1.7 },
